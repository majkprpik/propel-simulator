...
export function NewsBreakCampaigns() {
  ...
  const create = useMutation({
    ...
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ['newsbreak', 'campaigns'] }); setDialogOpen(false); setName(''); setObjective('CONVERSIONS'); setBudget(''); },
  });
